...
class ReportSurfaceInventoryTests(unittest.TestCase):
    ...
    def test_inventory_classifies_representative_surfaces(self) -> None:
        ...
        self.assertEqual(adaptive_compare["status"], "covered")
        self.assertIn("json_report", adaptive_compare["output_categories"])
        self.assertIn("markdown_report", adaptive_compare["output_categories"])
        self.assertIn("redaction_sidecar", adaptive_compare["output_categories"])
        ...
        refresh_report = by_command["ragflow-kb-build refresh-report"]
        self.assertEqual(refresh_report["status"], "covered")
        self.assertIn("redaction_sidecar", refresh_report["output_categories"])
        self.assertIn("markdown_report", refresh_report["output_categories"])

        parameter_audit = by_command["ragflow-kb-build parameter-audit"]
        self.assertEqual(parameter_audit["status"], "covered")
        self.assertIn("redaction_sidecar", parameter_audit["output_categories"])
        self.assertIn("markdown_report", parameter_audit["output_categories"])
        ...
        self.assertIn("json_report", consistency_check["output_categories"])
        self.assertIn("markdown_report", consistency_check["output_categories"])
        self.assertIn("redaction_sidecar", consistency_check["output_categories"])
        ...
        self.assertIn("redaction_sidecar", table_strategy["output_categories"])
        self.assertIn("markdown_report", table_strategy["output_categories"])
        ...
        self.assertEqual(evaluator_request["status"], "covered")
        self.assertIn("redaction_sidecar", evaluator_request["output_categories"])
        self.assertIn("markdown_report", evaluator_request["output_categories"])

        evaluator_review = by_command["ragflow-query evaluator review"]
        self.assertEqual(evaluator_review["status"], "covered")
        self.assertIn("redaction_sidecar", evaluator_review["output_categories"])
        self.assertIn("markdown_report", evaluator_review["output_categories"])
        ...
        finalize_review = by_command["ragflow-canonical-review finalize-review"]

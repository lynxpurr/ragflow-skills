...
class KbBuildTests(unittest.TestCase):
    ...
    def test_parameter_materialization_inventory_classifies_sidecars_and_ui_controls(self) -> None:
        ...
        self.assertEqual(by_field["ragflow_ui.image_context_window"]["status"], "unsupported_or_gated")
        ...
        self.assertEqual(by_field["ragflow_ui.table_context_window"]["status"], "unsupported_or_gated")
    ...
    def test_handoff_consumption_status_classifies_core_sidecars_assets_and_tables(self) -> None:
        ...
        self.assertEqual(parameter_fields["ragflow_ui.image_context_window"]["status"], "unsupported_or_gated")
        self.assertEqual(parameter_fields["ragflow_ui.image_context_window"]["api_key"], "parser_config.image_context_size")
        self.assertEqual(parameter_fields["ragflow_ui.table_context_window"]["status"], "unsupported_or_gated")
        ...
        self.assertEqual(report["summary"]["parameter_status_counts"]["unsupported_or_gated"], 3)

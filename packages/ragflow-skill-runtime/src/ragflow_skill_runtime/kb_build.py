...
def render_kb_asset_upload_plan_markdown(report: Mapping[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- planned_image_files: `{summary.get('planned_image_file_count', 0)}`",
        f"- missing_images: `{summary.get('missing_image_count', 0)}`",
        f"- orphan_images: `{summary.get('orphan_image_count', 0)}`",

...
This index records the disposition of the 12 Wave 3 reference candidates. References
describe current guidance but create no implementation, network, credential, mutation,
live-operation, staging, commit, push, or merge authority.

| Original path | Current or final path | Disposition | Original SHA-256 |
| --- | --- | --- | --- |
| `docs/02-architecture-design.md` | `docs/archive/2026/specs/02-architecture-design.md`; current replacement: `docs/reference/suite-architecture.md` | Archived snapshot; replaced by concise current architecture | `378c201ca9886eb6cacd0ef958acf9b59db50879db295653eccb29ea0abcb097` |
| `docs/05-cross-platform-smoke.md` | `docs/reference/cross-platform-smoke.md` | Normalized current reference | `bceb70f7e1fc19750fc32f7b612eec6c3f0fb2c0fd6205a25a77293d748cf5a9` |
| `docs/06-release-hardening.md` | `docs/reference/release-hardening.md` | Normalized current reference | `2880998f5fbb0bf36960476cf599fd50a9d7ee824124dee8dc5c70a3c6afb034` |
| `docs/08-cli-agent-integration.md` | `docs/reference/cli-agent-integration.md` | Normalized current reference | `8fc86bef46c7d34c528b64676afdcf8ba20025af4c48f6be94cd22a2413fb6e3` |
...
| `docs/branching-policy.md` | `docs/reference/branching-policy.md` | Normalized current reference | `08c465474e4ae5a18eb223bb0beb290aba609e6bc746b190a3302879b14feab6` |

...
| Live disposable optimization | Phase 17 live probe tests, Phase 26 disposable KB build/validation/cleanup execution/live tests, Phase 27 live enrichment tests | Command-manifest dry-run complete; live execution gated | Requires credentials, explicit confirmation, exact cleanup confirmation, and retained dataset IDs. |
...
1. Implement live disposable build/benchmark/cleanup execution with exact confirmation and retained cleanup artifacts.

...
python scripts/query.py rewrite "Question" --rewrite simple --report-json ./run/rewrite.json --report-md ./run/rewrite.md --redaction-report ./run/rewrite_redaction.json --json
python scripts/query.py intent classify "Compare runtime config versus metadata routing" --report-json ./run/intent.json --report-md ./run/intent.md --redaction-report ./run/intent_redaction.json --json
python scripts/query.py intent route "What about it?" --report-json ./run/intent_route.json --report-md ./run/intent_route.md --redaction-report ./run/intent_route_redaction.json --json
python scripts/query.py session inspect --session ./run/session.json --report-json ./run/session_inspect.json --report-md ./run/session_inspect.md --redaction-report ./run/session_inspect_redaction.json --json
python scripts/query.py session enrich "What about it?" --session ./run/session.json --report-json ./run/session_enrich.json --report-md ./run/session_enrich.md --redaction-report ./run/session_enrich_redaction.json --json
python scripts/query.py agentic-plan "Compare runtime configuration and metadata routing tradeoffs" --max-subqueries 3 --reflection-budget 1 --report-json ./run/agentic_plan.json --report-md ./run/agentic_plan.md --redaction-report ./run/agentic_plan_redaction.json --json
...
python scripts/query.py fallback-test --report-json ./run/fallback_test.json --report-md ./run/fallback_test.md --redaction-report ./run/fallback_test_redaction.json --json
...
python scripts/query.py route-test --routing-config ./templates/routing-config.example.json --queries ./templates/route-test-queries.example.json --report-json ./run/route_test.json --report-md ./run/route_test.md --redaction-report ./run/route_test_redaction.json
python scripts/query.py route-report --routing-config ./templates/routing-config.example.json --queries ./templates/route-test-queries.example.json --report-json ./run/route_report.json --report-md ./run/route_report.md --redaction-report ./run/route_report_redaction.json
python scripts/query.py route-diagnose --routing-config ./templates/routing-config.example.json --queries ./templates/route-test-queries.example.json --report-json ./run/route_diagnose.json --report-md ./run/route_diagnose.md --redaction-report ./run/route_diagnose_redaction.json
python scripts/query.py route-activation-check --activation-plan ./run/kb_activation_plan.json --routing-config ./routing-config.json --queries ./templates/route-test-queries.example.json --validation-report ./run/benchmark_report.json --min-hit-rate 0.8 --max-empty-result-rate 0.1 --report-json ./run/route_activation_check.json --report-md ./run/route_activation_check.md --redaction-report ./run/route_activation_check_redaction.json
python scripts/query.py assistant-profile recommend --assistant-profile ./handoff/assistant_profile.json --retrieval-hints ./handoff/retrieval_hints.json --kb-manifest ./run/kb_manifest.json --parse-report ./run/parse_report.json --activation-plan ./run/kb_activation_plan.json --report-json ./run/assistant_profile_recommendation.json --report-md ./run/assistant_profile_recommendation.md --redaction-report ./run/assistant_profile_recommendation_redaction.json
python scripts/query.py assistant-test-plan --test-plan ./handoff/assistant_test_plan.json --assistant-profile ./handoff/assistant_profile.json --retrieval-hints ./handoff/retrieval_hints.json --kb-manifest ./run/kb_manifest.json --parse-report ./run/parse_report.json --activation-plan ./run/kb_activation_plan.json --report-json ./run/assistant_test_plan_review.json --report-md ./run/assistant_test_plan_review.md --redaction-report ./run/assistant_test_plan_review_redaction.json
python scripts/query.py validation-suggestions --retrieval-hints ./handoff/retrieval_hints.json --queries-json ./run/queries.json --qrels-json ./run/qrels.json --report-json ./run/validation_suggestions.json --report-md ./run/validation_suggestions.md --redaction-report ./run/validation_suggestions_redaction.json --json
python scripts/query.py centroid build --plan-only --kb-manifest ./kb_manifest.json --chunk-snapshot ./chunk_snapshot.json --index-output ./run/centroids.json --report-json ./run/centroid_plan.json --report-md ./run/centroid_plan.md --redaction-report ./run/centroid_plan_redaction.json --json
python scripts/query.py centroid build --kb-manifest ./kb_manifest.json --chunk-snapshot ./chunk_snapshot.embeddings.json --index-output ./run/centroids.json --checkpoint ./run/centroid.checkpoint.json --batch-size 64 --embedding-model text-embedding-3-small --embedding-dimension 1536 --report-json ./run/centroid_build.json --report-md ./run/centroid_build.md --redaction-report ./run/centroid_build_redaction.json --json
...
python scripts/query.py audit-citations --query-output ./run/query.json --answer-file ./run/answer.md --report-json ./run/citation_audit.json --report-md ./run/citation_audit.md --redaction-report ./run/citation_audit_redaction.json
python scripts/query.py evaluate-answer --query-output ./run/query.json --answer-file ./run/answer.md --expected-term "known term" --require-citation --report-json ./run/answer_eval.json --report-md ./run/answer_eval.md --redaction-report ./run/answer_eval_redaction.json --json
python scripts/query.py evaluator request --query-output ./run/query.json --answer-file ./run/answer.md --expected-term "known term" --require-citation --provider-label external --model-label evaluator-model --report-json ./run/evaluator_request.json --report-md ./run/evaluator_request.md --redaction-report ./run/evaluator_request_redaction.json --json
python scripts/query.py evaluator review --query-output ./run/query.json --request ./run/evaluator_request.json --candidate ./run/evaluator_candidate.json --report-json ./run/evaluator_review.json --report-md ./run/evaluator_review.md --redaction-report ./run/evaluator_review_redaction.json --json
python scripts/query.py diagnose-result --query-output ./run/query.json --trace-json ./run/query_trace.json --citation-audit ./run/citation_audit.json --expected-modality image --expected-document sample-image.png --expected-dataset-id ds-placeholder --allowed-tag visual --report-json ./run/query_diagnostic.json --report-md ./run/query_diagnostic.md --redaction-report ./run/query_diagnostic_redaction.json
...
- Use `route-activation-check` offline with `kb_activation_plan_v1` to review route config registration, retrieval params, stale activation inputs, route-test coverage, optional saved validation thresholds, and optional centroid alignment. It does not mutate route config or RAGFlow.
- Use `assistant-profile recommend` offline with rich-handoff `assistant_profile.json`, optional `retrieval_hints.json`, and optional build evidence sidecars (`kb_manifest.json`, `parse_report.json`, `kb_activation_plan.json`) to review assistant retrieval settings. It does not mutate RAGFlow assistant settings.
- Use `assistant-test-plan` offline with rich-handoff `assistant_test_plan.json` plus optional build evidence sidecars to review staged assistant validation cases. It does not run an assistant, call an LLM, or mutate RAGFlow.
- Use `validation-suggestions` offline with `retrieval_hints.json` to generate benchmark-style `queries.json` and `qrels.json` suggestions for table/image validation. It does not call an LLM.
- For stronger optimize workflows, start with `ragflow-doc-to-md` rich handoff `retrieval_hints.json`, run `validation-suggestions` to seed table/image/mixed-modality benchmark artifacts, then feed those artifacts through `ragflow-kb-build benchmark preflight`, strict chunk snapshots or evidence maps, and `optimize summarize`. Document-only validation remains exploratory until strict evidence or modality coverage is present.
- After a profile experiment, use `diagnose-result`, `audit-citations`, `evaluate-answer`, `pollution-report`, or `rerank-ab` on saved query outputs when `optimize summarize` reports weak benchmark strength, unresolved followups, co-winners, cost review, or cleanup-pending status. These commands explain retrieval symptoms without changing KBs or assistant settings.
...
- Use `diagnose-result` to review weak retrieval, default routing, missing expected terms, wrong modality, missing image/table evidence, pollution, and citation-audit findings from saved artifacts.
...
- Use `endpoint-report` before live query work to classify configured RAGFlow/LLM/extra endpoints as local, LAN, VPN/private, or public; it writes redacted URL summaries, can emit `--redaction-report`, and only runs reachability checks when `--network-check` is passed. Reachability uses one attempt by default; pass `--retry-budget` and `--retry-backoff-seconds` for opt-in bounded retries.

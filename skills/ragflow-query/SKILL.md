...
- Use `route-report` offline to review hint coverage, missing route tests, ambiguous/low-confidence routes, short-hint word-boundary risks, substring conflicts, and per-KB `top_k` / `similarity_threshold` default coverage.

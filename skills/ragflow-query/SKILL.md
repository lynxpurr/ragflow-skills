...
python scripts/query.py route-activation-check --activation-plan ./run/kb_activation_plan.json --routing-config ./routing-config.json --queries ./templates/route-test-queries.example.json --report-json ./run/route_activation_check.json --report-md ./run/route_activation_check.md --redaction-report ./run/route_activation_check_redaction.json

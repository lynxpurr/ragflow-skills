...
def build_backend_parser() -> argparse.ArgumentParser:
    ...
    warmup.add_argument("--mineru-v4-model-version", choices=sorted(MINERU_V4_MODEL_CHOICES), help="MinerU v4 platform-compatible model_version; defaults to MINERU_V4_MODEL_VERSION or pipeline")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--mineru-base-url", help="MinerU service base URL; Agent API defaults to MINERU_BASE_URL or https://mineru.net/api/v1/agent, mineru-sync appends /parse when needed, mineru-fastapi uses /tasks, mineru-v4 accepts v4-compatible roots such as https://mineru.net or https://mineru.net/api/v4")
    ...
    parser.add_argument("--mineru-v4-model-version", choices=sorted(MINERU_V4_MODEL_CHOICES), help="MinerU v4 platform-compatible model_version; defaults to MINERU_V4_MODEL_VERSION or pipeline")

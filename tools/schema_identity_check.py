...
EXPECTED_IDENTITIES = (
    ...
    SchemaIdentity(
        ...
        source_patterns=("ragflow_document_features_v1", "DOCUMENT_FEATURES_SCHEMA"),
        coverage_patterns=("ragflow_document_features_v1", "DOCUMENT_FEATURES_SCHEMA"),
        description="No-conversion source feature report for adaptive document pipeline decisions.",
    ),
    SchemaIdentity(
        key="pipeline_decision",
        group="doc_convert",
        identity="ragflow_pipeline_decision_v1",
        source_patterns=("ragflow_pipeline_decision_v1", "PIPELINE_DECISION_SCHEMA"),
        coverage_patterns=("ragflow_pipeline_decision_v1", "PIPELINE_DECISION_SCHEMA"),
        description="Deterministic adaptive pipeline parameter decision report.",
    ),
    SchemaIdentity(
        key="adaptive_pipeline_summary",
        group="doc_convert",
        identity="ragflow_adaptive_pipeline_summary_v1",
        source_patterns=("ragflow_adaptive_pipeline_summary_v1", "ADAPTIVE_PIPELINE_SUMMARY_SCHEMA"),
        coverage_patterns=("ragflow_adaptive_pipeline_summary_v1", "ADAPTIVE_PIPELINE_SUMMARY_SCHEMA"),
    ...
    SchemaIdentity(
        key="canonical_table_equivalence",
        group="canonical_review",
        identity="ragflow_canonical_table_equivalence_v1",
        source_patterns=("ragflow_canonical_table_equivalence_v1", "CANONICAL_TABLE_EQUIVALENCE_SCHEMA"),
        coverage_patterns=("ragflow_canonical_table_equivalence_v1", "test_html_rowspan_and_colspan"),
        description="Deterministic normalized cell-matrix equivalence report for canonical Markdown and derived HTML.",
    ),
    SchemaIdentity(
        key="canonical_table_vlm_request",
        group="canonical_review",
        identity="ragflow_canonical_table_vlm_request_v1",
        source_patterns=("ragflow_canonical_table_vlm_request_v1", "CANONICAL_TABLE_VLM_REQUEST_SCHEMA"),
        coverage_patterns=("ragflow_canonical_table_vlm_request_v1", "test_vlm_request_and_matching"),
        description="No-LLM request artifact binding one exact source crop to one canonical table matrix.",
    ),
    SchemaIdentity(
        key="canonical_table_vlm_candidate",
        group="canonical_review",
        identity="ragflow_canonical_table_vlm_candidate_v1",
        source_patterns=("ragflow_canonical_table_vlm_candidate_v1", "CANONICAL_TABLE_VLM_CANDIDATE_SCHEMA"),
        coverage_patterns=("ragflow_canonical_table_vlm_candidate_v1", "test_vlm_candidate_mismatch"),
        description="External advisory/generated table matrix candidate contract; never a production truth.",
    ),
    SchemaIdentity(
        key="canonical_table_vlm_review",
        group="canonical_review",
        identity="ragflow_canonical_table_vlm_review_v1",
        source_patterns=("ragflow_canonical_table_vlm_review_v1", "CANONICAL_TABLE_VLM_REVIEW_SCHEMA"),
        coverage_patterns=("ragflow_canonical_table_vlm_review_v1", "test_vlm_request_and_matching"),
        description="Deterministic review report that blocks advisory VLM matrix discrepancies.",
    ),
    SchemaIdentity(
    ...
    SchemaIdentity(
        key="benchmark_source_attribution",
        group="benchmark",
        identity="ragflow_benchmark_source_attribution_v1",
        source_patterns=(
        ...
        description="Normalized benchmark source attribution artifact.",
    ),
    SchemaIdentity(
        key="benchmark_selection_report",
        group="benchmark",
        identity="ragflow_benchmark_selection_report_v1",
        source_patterns=(
        ...
        description="Normalized benchmark subset selection and sampling provenance artifact.",
    ),
    SchemaIdentity(
        key="benchmark_portfolio_config",
        group="benchmark",
        identity="ragflow_benchmark_portfolio_config_v1",
        source_patterns=("ragflow_benchmark_portfolio_config_v1", "CONFIG_SCHEMA"),
        coverage_patterns=("ragflow_benchmark_portfolio_config_v1", "CONFIG_SCHEMA"),
        description="Explicit-input configuration for offline benchmark portfolio aggregation.",
        source_roots=(Path("tools/benchmark_portfolio.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_benchmark_portfolio.py"),),
    ),
    SchemaIdentity(
        key="benchmark_portfolio",
        group="benchmark",
        identity="ragflow_benchmark_portfolio_v1",
        source_patterns=("ragflow_benchmark_portfolio_v1", "REPORT_SCHEMA"),
        coverage_patterns=("ragflow_benchmark_portfolio_v1", "REPORT_SCHEMA"),
        description="Public-safe offline multi-subset benchmark portfolio report.",
        source_roots=(Path("tools/benchmark_portfolio.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_benchmark_portfolio.py"),),
    ),
    SchemaIdentity(
    ...
    SchemaIdentity(
        key="benchmark_split_freeze",
        group="benchmark",
        identity="ragflow_benchmark_split_freeze_v1",
        source_patterns=("ragflow_benchmark_split_freeze_v1", "BENCHMARK_SPLIT_FREEZE_SCHEMA"),
        coverage_patterns=("ragflow_benchmark_split_freeze_v1", "create_benchmark_split_freeze", "verify_benchmark_split_freeze"),
        description="Immutable benchmark split provenance and input-hash freeze artifact.",
    ),
    SchemaIdentity(
        key="reviewed_retrieval_hints",
        group="kb_build",
        identity="ragflow_reviewed_retrieval_hints_v1",
        source_patterns=("ragflow_reviewed_retrieval_hints_v1", "REVIEWED_RETRIEVAL_HINTS_SCHEMA"),
        coverage_patterns=("ragflow_reviewed_retrieval_hints_v1", "create_reviewed_retrieval_hints", "validate_reviewed_retrieval_hints"),
        description="Hash-bound reviewed retrieval-hint activation artifact.",
    ),
    SchemaIdentity(
        key="chunk_snapshot",
        group="benchmark",
    ...
    SchemaIdentity(
        key="runtime_install_baseline",
        group="runtime",
        identity="ragflow_runtime_install_baseline_v1",
        source_patterns=("ragflow_runtime_install_baseline_v1", "BASELINE_SCHEMA"),
        coverage_patterns=("ragflow_runtime_install_baseline_v1", "BASELINE_SCHEMA"),
        description="Immutable release-bound runtime installation baseline manifest.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts.py"),),
    ),
    SchemaIdentity(
        key="runtime_count_only_drift",
        group="runtime",
        identity="ragflow_runtime_count_only_drift_v1",
        source_patterns=("ragflow_runtime_count_only_drift_v1", "COUNT_ONLY_DRIFT_SCHEMA"),
        coverage_patterns=("ragflow_runtime_count_only_drift_v1", "COUNT_ONLY_DRIFT_SCHEMA"),
        description="Release-safe count-only active runtime drift result.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts.py"),),
    ),
    SchemaIdentity(
        key="runtime_raw_delta_metadata",
        group="runtime",
        identity="ragflow_runtime_raw_delta_metadata_v1",
        source_patterns=("ragflow_runtime_raw_delta_metadata_v1", "RAW_DELTA_SCHEMA"),
        coverage_patterns=("ragflow_runtime_raw_delta_metadata_v1", "RAW_DELTA_SCHEMA"),
        description="Private raw runtime delta metadata retained outside public output.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts.py"),),
    ),
    SchemaIdentity(
        key="runtime_sanitized_candidate",
        group="runtime",
        identity="ragflow_runtime_sanitized_candidate_v1",
        source_patterns=("ragflow_runtime_sanitized_candidate_v1", "CANDIDATE_SCHEMA"),
        coverage_patterns=("ragflow_runtime_sanitized_candidate_v1", "CANDIDATE_SCHEMA"),
        description="Public-safe runtime promotion candidate classification.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts.py"),),
    ),
    SchemaIdentity(
        key="runtime_switch_result",
        group="runtime",
        identity="ragflow_runtime_switch_result_v1",
        source_patterns=("ragflow_runtime_switch_result_v1", "SWITCH_SCHEMA"),
        coverage_patterns=("ragflow_runtime_switch_result_v1", "SWITCH_SCHEMA"),
        description="Bounded active runtime update and switch result.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts.py"),),
    ),
    SchemaIdentity(
        key="runtime_rollback_result",
        group="runtime",
        identity="ragflow_runtime_rollback_result_v1",
        source_patterns=("ragflow_runtime_rollback_result_v1", "ROLLBACK_SCHEMA"),
        coverage_patterns=("ragflow_runtime_rollback_result_v1", "ROLLBACK_SCHEMA"),
        description="Runtime rollback success or blocking failure result.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts.py"),),
    ),
    SchemaIdentity(
        key="runtime_archive_inventory",
        group="runtime",
        identity="ragflow_runtime_archive_inventory_v1",
        source_patterns=("ragflow_runtime_archive_inventory_v1", "ARCHIVE_INVENTORY_SCHEMA"),
        coverage_patterns=("ragflow_runtime_archive_inventory_v1", "ARCHIVE_INVENTORY_SCHEMA"),
        description="Deterministic safe inventory of an exported runtime archive.",
        source_roots=(Path("packages/ragflow-skill-runtime/src/ragflow_skill_runtime/runtime_contracts.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts_check.py"),),
    ),
    SchemaIdentity(
        key="runtime_contracts_check",
        group="release",
        identity="ragflow_runtime_contracts_check_v1",
        source_patterns=("ragflow_runtime_contracts_check_v1", "SCHEMA"),
        coverage_patterns=("ragflow_runtime_contracts_check_v1", "run_runtime_contracts_check"),
        description="Release gate for runtime archive inventory and source-isolated import.",
        source_roots=(Path("tools/runtime_contracts_check.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_runtime_contracts_check.py"),),
    ),
    SchemaIdentity(
        key="consumer_acceptance",
        group="release",
        identity="ragflow_consumer_acceptance_v1",
        source_patterns=("ragflow_consumer_acceptance_v1", "SCHEMA"),
        coverage_patterns=("ragflow_consumer_acceptance_v1", "run_consumer_acceptance", "SCHEMA"),
        description="Clean-consumer report with release hashes and installed runtime tree evidence.",
        source_roots=(Path("tools/consumer_acceptance.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_consumer_acceptance.py"),),
    ),
    SchemaIdentity(
        key="public_hygiene_candidate_check",
        group="release",
        identity="ragflow_public_hygiene_candidate_check_v1",
        source_patterns=("ragflow_public_hygiene_candidate_check_v1", "SCHEMA"),
        coverage_patterns=(
            "ragflow_public_hygiene_candidate_check_v1",
            "run_public_hygiene_surface_check",
        ),
        description="Release gate for tracked, staged, and untracked public hygiene candidates.",
        source_roots=(Path("tools/public_hygiene_surface_check.py"),),
        coverage_roots=(Path("packages/ragflow-skill-runtime/tests/test_public_hygiene_surface_check.py"),),
    ),
    SchemaIdentity(
